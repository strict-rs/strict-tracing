...
pub fn instrument(args: proc_macro::TokenStream, item_tokens: proc_macro::TokenStream) -> proc_macro::TokenStream {
  tracing_attributes_internal::instrument(args.into(), item_tokens.into()).into()
}
