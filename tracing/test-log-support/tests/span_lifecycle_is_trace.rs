//! Verifies span lifecycle logs obey trace-level filtering.
...
mod tests {
  ...
  #[test]
  fn span_lifecycle_is_trace() -> Result<(), TestError> {
    let test = Test::try_with_filters(&[(module_path!(), log::LevelFilter::Trace), ("", log::LevelFilter::Info)])?;
