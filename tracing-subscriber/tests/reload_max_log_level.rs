...
mod tests {
  ...
  fn reload_max_log_level() -> Result<(), TestFailure> {
    ...
    ensure(log::log_enabled!(log::Level::Info), "info logs start enabled")?;
    ensure(!log::log_enabled!(log::Level::Debug), "debug logs start disabled")?;
    ensure(!log::log_enabled!(log::Level::Trace), "trace logs start disabled")?;
    ...
    ensure(log::log_enabled!(log::Level::Info), "info logs stay enabled")?;
    ensure(log::log_enabled!(log::Level::Debug), "debug logs become enabled")?;
    ensure(!log::log_enabled!(log::Level::Trace), "trace logs stay disabled")?;
